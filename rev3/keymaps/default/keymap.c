...
*/
  ...
  LT(SYMB,KC_GRV),  KC_LCTRL,   KC_LALT ,  KC_LEFT,  KC_RGHT, KC_NO,     KC_NO,  KC_UP,  KC_DOWN, LT(MDIA,KC_LBRC), CTL_T(KC_RBRC), KC_FN1,
...
[SYMB] = LAYOUT(
       ...
       KC_TRNS,  KC_EXLM,    KC_AT,  KC_LCBR,  KC_RCBR,  KC_PIPE, KC_TRNS,     KC_7,      KC_8,  KC_9, KC_ASTR,   KC_F12,
       KC_TRNS,  KC_HASH,   KC_DLR,  KC_LPRN,  KC_RPRN,   KC_GRV, KC_TRNS,     KC_4,      KC_5,  KC_6, KC_PLUS,  KC_TRNS,
...
// MEDIA AND MOUSE
[MDIA] = LAYOUT(
       KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS, KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_VOLU,  KC_VOLD,  KC_MUTE,
       KC_TRNS,  KC_TRNS,    KC_UP,  KC_TRNS,  KC_PGUP,  KC_TRNS, KC_TRNS,  KC_TRNS,  KC_MS_U,  KC_TRNS,  KC_TRNS,  KC_TRNS,
